...
public class PeripheralDimensional implements ITurtleUpgrade {
	...
	private void loadModelLocation() {
		...
		if(model_left == null) {
			model_left = new ModelResourceLocation("moreturtles:turtle_dimensional_left", "inventory");
			model_right= new ModelResourceLocation("moreturtles:turtle_dimensional_right", "inventory");
		}
