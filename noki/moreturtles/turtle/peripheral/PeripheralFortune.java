...
public class PeripheralFortune implements ITurtleUpgrade {
	...
	public static ModelResourceLocation model_left = new ModelResourceLocation("moreturtles:turtle_fortune_left", "inventory");
	@SideOnly(Side.CLIENT)
	public static ModelResourceLocation model_right = new ModelResourceLocation("moreturtles:turtle_fortune_right", "inventory");	
