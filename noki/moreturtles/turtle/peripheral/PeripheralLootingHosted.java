...
/**********
 * @class PeripheralLootingHosted
 *
 * @description Looting Turtleの周辺機器部分を定義するクラスです。
 * @description_en Class of the peripheral of Looting Turtle.
 */
public class PeripheralLootingHosted implements IPeripheral {
	...
	//******************************//
	public PeripheralLootingHosted(ITurtleAccess turtle, TurtleSide side) {
	...
	public String[] getMethodNames() {
		...
		return new String[] { "getName", "attack", "attackUp", "attackDown" };
	...
	private Object[] tryCommand(ILuaContext context, EnumFacing dir)
		...
		return this.turtle.executeCommand(context, new PeripheralLootingCommand(this.side, dir));
