...
public class PeripheralLuck implements ITurtleUpgrade {
	...
	private void loadModelLocation() {
		...
		if(model_left == null) {
			model_left = new ModelResourceLocation("moreturtles:turtle_luck_left", "inventory");
			model_right = new ModelResourceLocation("moreturtles:turtle_luck_right", "inventory");
		}
