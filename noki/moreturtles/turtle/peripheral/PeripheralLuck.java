...
public class PeripheralLuck implements ITurtleUpgrade {
	...
	public static ModelResourceLocation model_left = new ModelResourceLocation("moreturtles:turtle_luck_left", "inventory");
	@SideOnly(Side.CLIENT)
	public static ModelResourceLocation model_right = new ModelResourceLocation("moreturtles:turtle_luck_right", "inventory");
	...
	public ResourceLocation getUpgradeID() {
		...
		return new ResourceLocation("moreturtles:luck_turtle");
