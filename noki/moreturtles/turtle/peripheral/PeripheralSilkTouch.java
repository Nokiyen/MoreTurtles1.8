...
public class PeripheralSilkTouch implements ITurtleUpgrade {
	...
	private void loadModelLocation() {
		...
		if(model_left == null) {
			model_left = new ModelResourceLocation("moreturtles:turtle_silk_left", "inventory");
			model_right = new ModelResourceLocation("moreturtles:turtle_silk_right", "inventory");
		}
