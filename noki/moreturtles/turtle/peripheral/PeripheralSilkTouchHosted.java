...
/**********
 * @class PeripheralSilkTouchHosted
 *
 * @description SilkTouch Turtleの周辺機器部分を定義するクラスです。
 * @description_en Class of the peripheral of SilkTouch Turtle.
 */
public class PeripheralSilkTouchHosted implements IPeripheral {
	...
	//******************************//
	public PeripheralSilkTouchHosted(ITurtleAccess turtle, TurtleSide side) {
	...
	private Object[] tryCommand(ILuaContext context, EnumFacing dir)
		...
		return this.turtle.executeCommand(context, new PeripheralSilkTouchCommand(this.side, dir));
